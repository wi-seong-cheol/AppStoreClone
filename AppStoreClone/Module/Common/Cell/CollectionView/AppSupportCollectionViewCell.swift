//
//  AppSupportCollectionViewCell.swift
//  AppStoreClone
//
...
final class AppSupportCollectionViewCell: UICollectionViewCell {
    
    var disposeBag = DisposeBag()
    
    let onData: AnyObserver<SupportItem>
    ...
    override init(frame: CGRect) {
        let data = PublishSubject<SupportItem>()
    ...
    private func setup(data: PublishSubject<SupportItem>) {
